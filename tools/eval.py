...
def make_parser():
    ...
    parser.add_argument(
        "--num_machines", default=0, type=int, help="num of node for training"
    )#1
    parser.add_argument(
    ...
    parser.add_argument("-c", "--ckpt", default="/YOLOX_outputs/yolox_m/best_ckpt.pth", type=str, help="ckpt for eval")
